...
//		GUILayout.EndArea ();
	...
	public void GetAllPlayerData()
	{
		...
		GlobalScript.petDetails = new System.Collections.Generic.List<PetDetail>();
		...
		for(int i = 0; i < strPetDetails.Length; ++i)
		{
			...
			GlobalScript.petDetails.Add(tPet);
		}

		
		debugstr = tStr2 + '{' + GlobalScript.petDetails.Count.ToString();
	}
}
